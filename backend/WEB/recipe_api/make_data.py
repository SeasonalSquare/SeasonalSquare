...
def get_content(recipe_pk):
    ...
    allergy_data = {
        ...
        "7": ["맛술", "청주", '청주또는 미림', '맛술 미림', '맛술(미림)', '미림', '미림 또는 소주', '소주', '소주(청주)', '생강맛술또는 소주', '화이트와인', '정종'],
        "8": ['인스턴트커피', '녹차가루', '홍차 티백'],
        ...
        "10408": ["토란"],
        "10409": ["삶은 호박고구마", "고구마", "고구마 나감자", "작은 고구마", "찐 고구마", "고구마줄기", "고구마(대)", "고구마(중)", "고구마 중간크기", "고구마(2개)", "고구마(작은 것)", "찐고구마", "삶은 고구마", "고구마 3개 /큰거", "삶은 고구마 大", "고구마(찐것)", "삶은 호박고구마", "삶은 고구마(소)", "삶은 고구마", "작은 고구마", "고구마 큰거", "고구마 3개 /큰거", "고구마 (주먹만 한 거)", "밤고구마", "호박고구마"],
        "10410": ["시금치", "시금치 (잎 부분)"],
        "10411": ["마늘", "마늘쫑", "마늘 다진것", "마늘(편썬것)", "마늘다진것", "마늘 뚱뚱한거", "마늘(편으로 썰어서 준비)"],
